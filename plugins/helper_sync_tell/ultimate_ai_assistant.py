...
Be specific and actionable in your response.""",
            ...
            elif "uncertain" in content.lower() or "unclear" in content.lower():
            ...
            step_result["analysis"] = f"Error in analysis: {e!s}"
...
def register(llm_manager=None, atlas_app=None, agent_manager=None, **kwargs):
    ...
    try:
        ...
        logging.exception(f"Failed to register Ultimate AI Assistant: {e}")
...
__all__ = ["ProcessingMode", "ResponseQuality", "UltimateAIAssistant", "register"]
