...
def test_async_loading():
    ...
    # Add buttons
    ctk.CTkButton(
        control_frame, text="Load Large Plan (45 tasks)", command=load_plan
    ).pack(side="left", padx=5)
    ctk.CTkButton(
        control_frame, text="Load Small Plan (9 tasks)", command=load_small_plan
    ).pack(side="left", padx=5)
    ctk.CTkButton(control_frame, text="Clear Plan", command=clear_plan).pack(
        side="left", padx=5
    )
