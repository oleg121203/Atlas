...
class SettingsTestApp(ctk.CTk):
    ...
    def _create_widgets(self):
        ...
        # Title
        title_label = ctk.CTkLabel(main_frame, text="Settings Save Test", font=ctk.CTkFont(size=20, weight="bold"))
        ...
        self.test_button = ctk.CTkButton(button_frame, text="Test Save", command=self._test_save)
    ...
    def _test_save(self):
        ...
        try:
            ...
            def verify_save():
                time.sleep(1)
                self._load_current_settings()
                self.status_label.configure(text="Test completed - check if settings persisted", text_color="blue")
