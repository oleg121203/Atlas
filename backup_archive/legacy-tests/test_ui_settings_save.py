...
5. Check if settings are saved correctly"""
        ...
        self.test_button = ctk.CTkButton(
            button_frame, text="Test Save from UI", command=self._test_save_from_ui
        )
        self.test_button.pack(side="left", padx=5)

        self.verify_button = ctk.CTkButton(
            button_frame, text="Verify File", command=self._verify_file
        )
    ...
    def _test_save_from_ui(self):
        ...
        try:
            ...
            def verify_save():
                ...
                self._load_current_settings()
                self.status_label.configure(
                    text="Test completed - check if UI settings persisted",
                    text_color="blue",
                )
    ...
    def _verify_file(self):
        ...
        try:
            ...
            self.status_label.configure(
                text=f"Verification error: {e}", text_color="red"
            )
