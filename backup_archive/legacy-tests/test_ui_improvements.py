...
def test_context_menu():
    ...
    textbox.insert(
        "1.0",
        "Test text for context menu. Try right-clicking or using Ctrl+C, Ctrl+V, Ctrl+X, Ctrl+A",
    )
    ...
    print(
        "Context menu test window opened. Test the functionality and close when done."
    )
    root.mainloop()
...
def test_compact_chat():
    ...
    test_messages = [
        ...
        (
            "agent",
            "Sure! The compact mode shows fewer lines and uses shorter spacing for system messages.",
        ),
        ("system", "🔧 Automatic mode detection enabled"),
        ("user", "What about the thinking process messages?"),
        (
            "agent",
            "Thinking process messages are displayed in a very dimmed gray color with minimal spacing to show the AI's internal processing.",
        ),
        ("system", "🌐 Translation: Ready"),
        (
            "user",
            "This is great! The compact mode makes it much easier to follow the conversation.",
        ),
        (
            "agent",
            "Exactly! The compact mode helps focus on the main conversation while still showing important system information in a subtle way.",
        ),
        ("system", "Processing your request..."),
        ("user", "Can I toggle between compact and full view?"),
        (
            "agent",
            "Yes! Click the ▼ button in the top-left corner to toggle between compact and full view modes.",
        ),
    ]
    ...
    print(
        "Compact chat test window opened. Watch the messages appear and test the compact toggle."
    )
    root.mainloop()
...
"""
    ...
    print(
        "Keyboard shortcuts test window opened. Test the shortcuts and close when done."
    )
    root.mainloop()
