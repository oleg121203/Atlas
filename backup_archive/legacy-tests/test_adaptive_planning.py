...
def test_complexity_levels():
    ...
    test_goals = [
        ...
        (
            "Complex goal",
            "Create a comprehensive automation system that monitors system performance and generates detailed reports",
        ),
    ]
    ...
    for goal_name, goal_text in test_goals:
        ...
        print(
            f"   • Expected tasks: {complexity['phases']} × {complexity['tasks_per_phase']} × {complexity['actions_per_task']} = {complexity['phases'] * complexity['tasks_per_phase'] * complexity['actions_per_task']}"
        )
