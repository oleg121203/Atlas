...
def test_scrolling():
    ...
    info_label = ctk.CTkLabel(
        root, text="Test scrolling with 40 items. Use scroll wheel or scrollbar."
    )
    ...
    print(
        "Scrolling test started. You should see 40 items and be able to scroll to see all of them."
    )
