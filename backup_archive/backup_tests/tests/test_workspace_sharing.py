...
class TestWorkspaceSharing(unittest.TestCase):
    ...
    def test_create_workspace_success(self):
        result = self.workspace_sharing.create_workspace(
            "ws1", "Test Workspace", "user1"
        )
        self.assertTrue(result)
        self.assertIn("ws1", self.workspace_sharing.workspaces)
        self.assertEqual(
            self.workspace_sharing.workspaces["ws1"]["name"], "Test Workspace"
        )
    ...
    def test_add_member_success(self):
        ...
        self.assertEqual(
            self.workspace_sharing.workspaces["ws1"]["members"]["user2"], "editor"
        )
    ...
    def test_update_member_role_success(self):
        ...
        self.assertTrue(result)
        self.assertEqual(
            self.workspace_sharing.workspaces["ws1"]["members"]["user2"], "manager"
        )
    ...
    def test_add_resource_success(self):
        ...
        result = self.workspace_sharing.add_resource(
            "ws1", "res1", "document", permissions
        )
        self.assertTrue(result)
        self.assertIn("res1", self.workspace_sharing.workspaces["ws1"]["resources"])
        self.assertEqual(
            self.workspace_sharing.workspaces["ws1"]["resources"]["res1"]["type"],
            "document",
        )
        self.assertEqual(
            self.workspace_sharing.workspaces["ws1"]["resources"]["res1"][
                "permissions"
            ],
            permissions,
        )
    ...
    def test_check_access_success(self):
        ...
        self.assertTrue(
            self.workspace_sharing.check_access("ws1", "user2", "res1", "read")
        )
        self.assertTrue(
            self.workspace_sharing.check_access("ws1", "user2", "res1", "write")
        )
        self.assertFalse(
            self.workspace_sharing.check_access("ws1", "user2", "res1", "delete")
        )
    ...
    def test_check_access_user_not_member(self):
        ...
        self.workspace_sharing.add_resource("ws1", "res1", "document", permissions)
        self.assertFalse(
            self.workspace_sharing.check_access("ws1", "user3", "res1", "read")
        )

    def test_check_access_resource_not_found(self):
        self.workspace_sharing.create_workspace("ws1", "Test Workspace", "user1")
        self.assertFalse(
            self.workspace_sharing.check_access("ws1", "user1", "res2", "read")
        )
