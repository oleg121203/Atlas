...
from tools.image_recognition_tool import find_object_in_image, find_template_in_image
...
class TestImageRecognitionTool(unittest.TestCase):
    ...
    def test_find_template_success(
        self, mock_minMaxLoc, mock_matchTemplate, mock_imread
    ):
    ...
    def test_find_object_success(
        self, mock_CascadeClassifier, mock_cvtColor, mock_imread
    ):
