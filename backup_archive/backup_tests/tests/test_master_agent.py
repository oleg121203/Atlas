...
class TestMasterAgentEnvironmentalAdaptation(unittest.TestCase):
    ...
    def test_successful_recovery_after_tool_not_found(self, mock_generate_plan):
        ...
        def execute_tool_side_effect(called_tool_name, *args, **kwargs):
            ...
            if (
                ...
                and self.mock_agent_manager.execute_tool.call_count == 1
            ):
            ...
            # Third call for the tool succeeds
                ...
                return {
                    "status": "success",
                    "output": "Tool executed successfully after creation.",
                }
    ...
    def test_successful_recovery_after_invalid_tool_arguments(self, mock_generate_plan):
        ...
        def execute_tool_side_effect(*args, **kwargs):
            ...
            return {
                "status": "success",
                "output": "Replanned and executed successfully.",
            }
    ...
    def test_execution_stops_after_max_retries(self, mock_generate_plan):
        ...
        self.mock_agent_manager.execute_tool.side_effect = Exception(
        ...
        self.assertEqual(
            self.mock_agent_manager.execute_tool.call_count,
            self.master_agent.MAX_RETRIES,
        )
