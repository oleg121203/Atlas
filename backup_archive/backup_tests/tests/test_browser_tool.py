...
class TestBrowserTool(unittest.TestCase):
    ...
    def test_find_links(self):
        ...
        self.assertEqual(result, expected_result)
        self.navigation.find_links.assert_called_once_with(
            selector, text_contains, timeout
        )
    ...
    def test_click_link(self):
        ...
        expected_result = {
            "success": True,
            "data": {"message": "Link clicked successfully"},
        }
        ...
        self.assertEqual(result, expected_result)
        self.navigation.click_link.assert_called_once_with(
            selector, text_contains, timeout
        )
