...
class TestCorePerformance:
    ...
    def test_master_agent_initialization_latency(self, benchmark):
        ...
        def setup_master_agent():
            ...
            with (
                patch("agents.master_agent.AgentManager"),
    ...
    def test_llm_manager_response_time(self, benchmark):
        ...
        def process_mock_response():
            with (
                patch("utils.llm_manager.openai"),
                ...
                return llm_manager._extract_content_from_response(
...
class TestToolPerformance:
    ...
    def test_code_reader_tool_latency(self, benchmark):
        ...
        def read_mock_code():
            with (
                patch("tools.code_reader_tool.os.path.exists", return_value=True),
                patch(
                    "builtins.open", mock_open_read_data="# Test code\nprint('hello')\n"
                ),
            ):
