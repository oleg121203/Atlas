...
class TestAgentManager(unittest.TestCase):
    ...
    def test_add_and_get_agent(self):
        ...
        self.assertEqual(
            retrieved_agent,
            mock_agent,
            "Should retrieve the same agent instance that was added.",
        )
    ...
    def test_get_nonexistent_agent(self):
        ...
        self.assertIsNone(
            retrieved_agent, "Should return None for a non-existent agent."
        )
    ...
    def test_list_agent_names(self):
        ...
        self.assertCountEqual(
            agent_names,
            ["Agent One", "Agent Two"],
            "Should return the names of all registered agents.",
        )
