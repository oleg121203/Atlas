...
class TestConflictResolution(unittest.TestCase):
    ...
    def test_log_conflict(self):
        conflict = self.conflict_resolution.log_conflict(
            "doc1", "user1", "User1 edit", "Base content"
        )
    ...
    def test_get_conflicts(self):
        self.conflict_resolution.log_conflict(
            "doc1", "user1", "User1 edit", "Base content"
        )
        self.conflict_resolution.log_conflict(
            "doc1", "user2", "User2 edit", "Base content"
        )
    ...
    def test_resolve_conflict_success(self):
        ...
        result = self.conflict_resolution.resolve_conflict(
            "doc1", 0, "Merged content", "user2"
        )
