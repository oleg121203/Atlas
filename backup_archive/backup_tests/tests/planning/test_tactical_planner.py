...
class TestTacticalPlanner:
    ...
    def test_generate_tactical_plan_success(
    ...
    def test_generate_tactical_plan_invalid_json(
        self, mock_llm_manager, mock_memory_manager
    ):
    ...
    def test_generate_tactical_plan_llm_error(
        self, mock_llm_manager, mock_memory_manager
    ):
