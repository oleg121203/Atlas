...
class TestRBACManager(unittest.TestCase):
    ...
    def test_add_role_success(self):
        ...
        self.assertEqual(
            self.rbac_manager.roles["tester"]["permissions"], {"test", "read"}
        )
    ...
    def test_add_role_duplicate(self):
        ...
        self.assertEqual(
            self.rbac_manager.roles["user"]["permissions"], {"read", "write"}
        )
    ...
    def test_update_role_permissions_success(self):
        ...
        self.assertTrue(result)
        self.assertEqual(
            self.rbac_manager.roles["user"]["permissions"], {"read", "comment"}
        )
    ...
    def test_add_policy(self):
        ...
        self.assertEqual(
            self.rbac_manager.policies["user123"]["project1"], ["read", "write"]
        )
    ...
    def test_check_policy_with_permission(self):
        ...
        self.assertFalse(
            self.rbac_manager.check_policy("user123", "project1", "delete")
        )
