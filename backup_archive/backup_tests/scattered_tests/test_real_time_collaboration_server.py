...
class TestCollaborationServer(unittest.TestCase):
    ...
    def test_handle_message_valid_json(self):
        ...
        with (
            patch.object(self.server, "broadcast") as mock_broadcast,
            patch.object(self.server, "check_for_conflict", return_value=False),
        ):
    ...
    def test_handle_message_invalid_json(self):
        ...
        with patch("builtins.print") as mock_print:
            ...
            mock_print.assert_called_with(
                f"Invalid JSON received from {mock_ws.remote_address}"
            )
