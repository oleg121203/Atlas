    ...
    test_scenarios = [
        (
            ...
            [
                ...
                (
                    ...
                    "I'd be happy to help you check the weather.",
                ),
                (
                    "Tell me a joke",
        ...
        (
            ...
            [
                (
                    "What can you do?",
                    "I'm Atlas with automation, screen analysis, and system integration capabilities.",
                ),
                (
                    "How do I use development mode?",
                    "Development mode provides enhanced debugging with safety features.",
                ),
                (
                    "What tools are available?",
                    "I have screenshot, OCR, mouse/keyboard, file operations and more.",
                ),
            ],
        ),
        (
            ...
            [
                (
                    "Take a screenshot",
                    "I'll capture a screenshot of your desktop right away.",
                ),
                ("Open calculator", "I'll help you open the calculator application."),
                (
                    "Send notification",
                    "I can send an email notification with the details you specify.",
                ),
            ],
        ),
        (
            ...
            [
                (
                    "Show debug info",
                    "🔧 DEV MODE: Here's detailed system debug info with safety protocols.",
                ),
                (
                    "Analyze performance",
                    "🔧 DEV MODE: Running performance analysis with enhanced diagnostics.",
                ),
                (
                    "Test features",
                    "🔧 DEV MODE: Testing experimental features with full safety checks.",
                ),
            ],
        ),
    ]
