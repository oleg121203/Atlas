...
try:
    ...
    print("Warning: pyaudio or speech_recognition not available. Voice command functionality will be disabled.")
...
class VoiceCommandParser:
    ...
    def listen_for_command(self, timeout: int = 5, phrase_time_limit: Optional[int] = None) -> Optional[str]:
