...
class ActivityTracking:
    ...
    def log_activity(self, user_id: str, action: str, resource_id: str, details: Optional[Dict] = None) -> None:
    ...
    def get_resource_activities(self, resource_id: str) -> List[Dict]:
        ...
        return [activity for activity in self.activities if activity['resource_id'] == resource_id]
    ...
    def setup_routes(self):
        ...
        def log_activity_route():
            ...
            try:
                ...
                return jsonify({'message': f'Activity logged for user {decoded["user"]}'})
            except Exception as e:
