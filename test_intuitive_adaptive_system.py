    ...
    for i, goal in enumerate(test_goals, 1):
        ...
        try:
            ...
            if level == "simple" and total_processes > 5:
                print(f"   ⚠️ WARNING: Simple goal created {total_processes} processes (should be 1-5)")
            elif level == "medium" and (total_processes < 6 or total_processes > 15):
                print(f"   ⚠️ WARNING: Medium goal created {total_processes} processes (should be 6-15)")
            elif level == "complex" and total_processes < 16:
                print(f"   ⚠️ WARNING: Complex goal created {total_processes} processes (should be 16-30)")
            else:
