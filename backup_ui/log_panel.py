...
class LogPanel(ctk.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        self.log_textbox = ctk.CTkTextbox(self, font=("monospace", 12), state="disabled")
        ...
        ctk.CTkButton(btn_frame, text="Copy All", command=self.copy_all).pack(side="left", padx=5)
