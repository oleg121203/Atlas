...
- [ ] **M2:** Створення резервної копії та нової структури
- [ ] **M3:** Об'єднання кращих версій файлів  
- [ ] **M4:** Виправлення всіх імпортів
- [ ] **M5:** Оновлення конфігурацій запуску
- [ ] **M6:** Тестування функціональності
- [ ] **M7:** Очищення та фіналізація
