...
def test_plugin_system():
    ...
    print(f"Gmail authentication status: {json.dumps({
...
def test_plugin_creation():
    ...
    class TestPlugin(BasePlugin):
        ...
        def execute(self, command: str, **kwargs) -> PluginResult:
            if command == "hello":
                return PluginResult(
                    success=True,
                    data={"message": f"Hello from test plugin! Provider: {self.active_provider}"},
    ...
    print(f"Hello command result: {json.dumps({
    ...
    print(f"Echo command result: {json.dumps({
    ...
    print(f"Unknown command result: {json.dumps({
