...
from PySide6.QtWidgets import QDialog, QVBoxLayout, QHBoxLayout, QLabel, QLineEdit, QPushButton, QComboBox, QTextEdit
...
class ModalDialog(QDialog):
    ...
    def toggle_advanced_options(self):
        ...
        self.advanced_btn.setText("Hide Advanced Options" if is_visible else "Show Advanced Options")
        # TODO: Add animation for expanding/collapsing
        logger.info(f"Advanced options toggled: {'visible' if is_visible else 'hidden'}")
    ...
    def get_data(self):
        ...
        data = {
            ...
            "description": self.desc_input.toPlainText() if self.advanced_fields.isVisible() else ""
        }
