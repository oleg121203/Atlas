...
from PyQt5.QtWidgets import QWidget, QVBoxLayout, QHBoxLayout, QTextEdit, QPushButton, QLabel, QComboBox
from PyQt5.QtCore import Qt, pyqtSignal

from core.logging import get_logger
from core.ai_integration import get_ai_model_manager, AIIntegrationError
...
class AIAssistantWidget(QWidget):
    ...
    suggestionReceived = pyqtSignal(str)
    taskAutomated = pyqtSignal(dict)
    ...
    def setup_ui(self):
        ...
        self.input_text.setPlaceholderText("Enter your request or question for the AI assistant...")
    ...
    def update_model_list(self):
        ...
        for model_name in self.ai_manager.models.keys():
    ...
    def request_suggestion(self):
        ...
        try:
            ...
            suggestion = self.ai_manager.get_suggestion(model_name, context, prompt_type)
    ...
    def request_automation(self):
        ...
        if not user_input:
            self.output_text.setText("Error: Please enter a task description to automate.")
        ...
        try:
            automation_plan = self.ai_manager.automate_task(model_name, user_input, context)
