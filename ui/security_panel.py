...
class SecurityPanel(ctk.CTkFrame):
    def __init__(self, master, plugin_manager, plugin_enabled_vars, notification_email_var, notification_telegram_var, notification_sms_var, *args, **kwargs):
    ...
    def _build_ui(self):
        ...
        # Rules Textbox
        ctk.CTkLabel(self, text="Security Rules (one per line)").grid(row=1, column=0, padx=10, pady=(10, 0), sticky="w")
