...
class OnboardingTutorial(QDialog):
    ...
    def init_ui(self):
        ...
        self.demo_area.setStyleSheet("background-color: #f0f0f0; border: 1px solid #ccc;")
    ...
    def update_content(self):
        ...
        colors = ['#f0f0f0', '#e6f2ff', '#fff0e6', '#e6ffe6', '#ffe6f2', '#ffffe6', '#e6e6ff']
        self.demo_area.setStyleSheet(f"background-color: {colors[self.current_step % len(colors)]}; border: 1px solid #ccc;")
