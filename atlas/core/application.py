...
from atlas.core.plugin_system import PluginSystem
from atlas.core.self_healing import SelfHealingSystem
...
class AtlasApplication:
    ...
    def _import_and_initialize_components(self):
        ...
        from atlas.tools.tool_manager import ToolManager
