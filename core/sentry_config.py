...
def capture_exception(exception: Optional[Exception] = None) -> Optional[str]:
    ...
    Convenience function that delegates to the SentryManager singleton.
    ...
    Returns:
        Optional[str]: Event ID if sent successfully, None otherwise
    """
    return get_sentry_manager().capture_exception(exception)
...
def capture_message(
    ...
    Returns:
        Optional[str]: Event ID if sent successfully, None otherwise
    """
    return get_sentry_manager().capture_message(message, level, tags)
...
def set_user(
    ...
    Args:
        ...
        username: The user's username
    """
    get_sentry_manager().set_user(user_id, email, username)
