...
from modules.agents.enhanced_memory_manager import EnhancedMemoryManager, MemoryType
from modules.agents.master_agent import MasterAgent as BaseMasterAgent
...
class TaskAwareMasterAgent(BaseMasterAgent):
    ...
    def _handle_screen_goal(self, goal: str) -> bool:
        ...
        try:
            ...
            if not screen_agent:
                from modules.agents.screen_agent import ScreenAgent
    ...
    def _handle_system_goal(self, goal: str) -> bool:
        ...
        try:
            ...
            if not system_agent:
                from modules.agents.system_interaction_agent import SystemInteractionAgent
    ...
    def _handle_text_goal(self, goal: str) -> bool:
        ...
        try:
            ...
            if not text_agent:
                from modules.agents.text_agent import TextAgent
