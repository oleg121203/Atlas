...
class TestAIAutomation(unittest.TestCase):
    ...
    def test_prioritize_tasks(self):
        ...
        tasks = [
            ...
            {'name': 'Long term project planning document', 'due_date': 'not specified', 'created_from_text': False},
        ...
        urgent_task = next(task for task in prioritized if task['name'] == 'Urgent report')
    ...
    def test_extract_task_from_text(self):
        ...
        expected_results = [
            {'name': 'Prepare presentation', 'due_date': 'next Friday', 'priority': 'medium', 'created_from_text': True},
            {'name': 'call client', 'due_date': 'tomorrow', 'priority': 'medium', 'created_from_text': True},
            {'name': 'complete report', 'due_date': '12/15/25', 'priority': 'medium', 'created_from_text': True},
            None,
            {'name': 'Review budget', 'due_date': '12-15-25', 'priority': 'medium', 'created_from_text': True}
        ]
