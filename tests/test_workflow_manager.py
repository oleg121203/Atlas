...
class TestWorkflowManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config = {
            "workflow_states_dir": "workflows/states",
            "max_retries": 3
        }
    ...
    def test_create_workflow(self):
        ...
        success = self.workflow_manager.create_workflow("test_workflow", self.sample_workflow)
        self.assertTrue(success, "Workflow creation should succeed")
        self.assertIn("test_workflow", self.workflow_manager.workflows, "Workflow should be in manager")
        state = self.workflow_manager.get_workflow_state("test_workflow")
        self.assertEqual(state["status"], "created", "Workflow status should be created")
    ...
    def test_start_workflow(self):
        ...
        state = self.workflow_manager.get_workflow_state("test_workflow")
        self.assertEqual(state["status"], "running", "Workflow status should be running")
    ...
    def test_execute_step_success(self):
        ...
        state = self.workflow_manager.get_workflow_state("test_workflow")
        self.assertEqual(state["current_step"], "process", "Workflow should move to next step")
        self.assertEqual(state["status"], "running", "Workflow status should remain running")
    ...
    def test_execute_step_failure(self):
        ...
        self.assertIsNotNone(state["error"], "Workflow state should contain error information")
    ...
    def test_retry_step(self):
        ...
        state = self.workflow_manager.get_workflow_state("test_workflow")
        self.assertEqual(state["retry_count"], 2, "Retry count should be incremented again")
    ...
    def test_retry_max_attempts(self):
        ...
        state = self.workflow_manager.get_workflow_state("test_workflow")
        self.assertEqual(state["status"], "failed", "Workflow status should be failed after max retries")
    ...
    def test_rollback_workflow(self):
        ...
        state = self.workflow_manager.get_workflow_state("test_workflow")
        self.assertEqual(state["current_step"], "start", "Workflow should rollback to last successful step")
        self.assertEqual(state["status"], "running", "Workflow status should be running after rollback")
    ...
    def test_persist_and_load_workflow_state(self):
        ...
        self.assertEqual(state["current_step"], "process", "Loaded state should match executed state")
