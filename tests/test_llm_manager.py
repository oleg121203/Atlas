...
class TestLLMManager(unittest.TestCase):
    ...
    def test_chat_without_cache(self):
        ...
        mock_response = {"content": "New response", "tool_calls": None, "prompt_tokens": 10, "completion_tokens": 20, "total_tokens": 30}
        ...
        self.mock_provider.chat.assert_called_once_with(messages, None, "mock_model", None)
