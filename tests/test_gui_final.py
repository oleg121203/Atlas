...
1. Симуляція збереження та завантаження налаштувань через GUI
2. Перевірка, що EnhancedSettingsView працює з правильним ConfigManager
"""
...
def test_gui_settings():
    ...
    try:
        ...
        # Тестуємо створення GUI (без фактичного відображення)
        try:
...
def test_config_consistency():
    ...
    try:
        ...
        # а utils_config читає з INI + YAML, і у нас може бути різна логіка завантаження
