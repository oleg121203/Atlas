...
class TestRealTimeCollaboration(unittest.TestCase):
    ...
    def test_create_task_success(self):
        result = self.collaboration.create_task('ws1', 'task1', 'Test Task', 'Do something', ['user1', 'user2'], 'user1')
    ...
    def test_create_task_duplicate(self):
        self.collaboration.create_task('ws1', 'task1', 'Test Task', 'Do something', ['user1'], 'user1')
        result = self.collaboration.create_task('ws1', 'task1', 'Duplicate Task', 'Do something else', ['user2'], 'user2')
    ...
    def test_update_task_status_success(self):
        self.collaboration.create_task('ws1', 'task1', 'Test Task', 'Do something', ['user1'], 'user1')
        result = self.collaboration.update_task_status('ws1', 'task1', 'in_progress', 'user1')
        self.assertTrue(result)
        task = self.collaboration.tasks['ws1']['task1']
    ...
    def test_update_task_status_not_found(self):
        result = self.collaboration.update_task_status('ws1', 'task2', 'in_progress', 'user1')
        self.assertFalse(result)

    def test_get_tasks(self):
        self.collaboration.create_task('ws1', 'task1', 'Task 1', 'Do something', ['user1'], 'user1')
        self.collaboration.create_task('ws1', 'task2', 'Task 2', 'Do something else', ['user2'], 'user1')
