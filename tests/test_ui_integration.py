...
class TestPluginUIIntegration:
    ...
    def test_plugin_settings_ui(self, qapp):
        ...
        self.plugins_module.list.setCurrentRow(0)
        settings_widget = self.plugins_module.plugins_frame.findChild(QWidget, "settings_widget")
    ...
    def test_plugin_tools_ui(self, qapp):
        ...
        # Check tools widget
        self.plugins_module.list.setCurrentRow(0)
        tools_widget = self.plugins_module.plugins_frame.findChild(QWidget, "tools_widget")
