...
class TestUserManager(unittest.TestCase):
    ...
    def test_create_user_success(self):
        result = self.user_manager.create_user('testuser', 'password123', 'test@example.com', 'user')
        self.assertTrue(result)
        self.assertIn('testuser', self.user_manager.users)
        self.assertEqual(self.user_manager.users['testuser']['email'], 'test@example.com')
        self.assertEqual(self.user_manager.users['testuser']['role'], 'user')
        self.assertNotEqual(self.user_manager.users['testuser']['password'], 'password123')  # Should be hashed

    def test_create_user_duplicate(self):
        self.user_manager.create_user('testuser', 'password123', 'test@example.com')
        result = self.user_manager.create_user('testuser', 'password456', 'test2@example.com')
        self.assertFalse(result)
        self.assertEqual(self.user_manager.users['testuser']['email'], 'test@example.com')  # Original unchanged
    ...
    def test_get_user(self):
        self.user_manager.create_user('testuser', 'password123', 'test@example.com', 'admin')
    ...
    def test_update_user_role(self):
        self.user_manager.create_user('testuser', 'password123', 'test@example.com', 'user')
    ...
    def test_get_all_users(self):
        ...
        self.assertTrue(all('password' not in user for user in users))  # Passwords should be excluded
    ...
    def test_get_users_endpoint_admin_access(self):
        self.user_manager.create_user('adminuser', 'password123', 'admin@example.com', 'admin')
