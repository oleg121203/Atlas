...
class TestMarketingDashboard(unittest.TestCase):
    ...
    def setUp(self):
        ...
        for file in ["social_media_data_AtlasMarketing.json", "partnership_data.json", "marketing_analytics.json"]:
    ...
    def test_add_content_to_campaign(self):
        ...
        self.assertEqual(self.dashboard.campaigns_table.item(initial_rows, 1).text(), "Test Campaign Content")
    ...
    def test_add_partner(self):
        ...
        self.assertEqual(self.dashboard.partnerships_table.item(initial_rows, 1).text(), "Test Partner")
