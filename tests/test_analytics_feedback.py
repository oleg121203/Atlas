...
class TestMarketingAnalytics(unittest.TestCase):
    def setUp(self):
        ...
        self.analytics.channel_metrics = {'Twitter': [], 'Instagram': [], 'LinkedIn': [], 'Email': [], 'Website': []}
    ...
    def test_add_campaign(self):
        campaign = self.analytics.add_campaign("TestCampaign", "2025-06-01", "2025-06-30", ["Twitter"])
    ...
    def test_record_conversion(self):
        campaign = self.analytics.add_campaign("TestCampaign", "2025-06-01", "2025-06-30", ["Twitter"])
        conversion = self.analytics.record_conversion(campaign['id'], "Twitter", "SignUp", 5)
    ...
    def test_get_campaign_performance(self):
        campaign = self.analytics.add_campaign("TestCampaign", "2025-06-01", "2025-06-30", ["Twitter", "Instagram"])
    ...
    def test_recommend_strategy_adjustment(self):
        self.analytics.update_channel_metrics("Twitter", 1000, 10, 2, 50.0)  # Low CTR, high CPC/CPA
        recommendations = self.analytics.recommend_strategy_adjustment(min_ctr=2.0, max_cpc=1.0, max_cpa=10.0)
