...
class PluginLoadTest(unittest.TestCase):
    ...
    def test_load_multiple_plugins(self):
        ...
        for i in range(num_plugins):
            ...
            plugins_dict[plugin_name] = {
                'manifest': {'name': f'Plugin {i}', 'version': '1.0', 'description': f'Test Plugin {i}'},
                'tools': [],
                'agents': []
            }
    ...
    def test_enable_multiple_plugins(self):
        ...
        self.assertLess(end_time - start_time, 2.0, "Enabling 100 plugins took too long")
    ...
    def test_plugin_status_check_under_load(self):
        ...
        self.assertLess(end_time - start_time, 1.0, "Checking status of 100 plugins took too long")
