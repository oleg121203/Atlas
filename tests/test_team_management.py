...
class TestTeamManagement(unittest.TestCase):
    ...
    def test_add_team_member(self):
        ...
        self.cursor.execute("INSERT INTO team_members (name, role, permission_level) VALUES (?, ?, ?)", 
    ...
    def test_assign_task(self):
        ...
        self.cursor.execute("INSERT INTO tasks (title, description, assigned_to, due_date) VALUES (?, ?, ?, ?)", 
    ...
    def test_productivity_analytics(self):
        ...
        self.cursor.execute("INSERT INTO team_members (name, role, permission_level) VALUES (?, ?, ?)", 
                           ("Test Member", "Developer", "Member"))
        self.cursor.execute("INSERT INTO tasks (title, description, assigned_to, due_date, status) VALUES (?, ?, ?, ?, ?)", 
