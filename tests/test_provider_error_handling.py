...
class TestProviderErrorHandling(unittest.TestCase):
    ...
    def test_openai_provider_error_handling(self):
        ...
        with patch.object(OpenAIProvider, 'is_available', return_value=True):
            with patch.object(OpenAIProvider, 'chat', side_effect=Exception("API Error")):
    ...
    def test_gemini_provider_error_handling(self):
        ...
        with patch.object(GeminiProvider, 'is_available', return_value=True):
            with patch.object(GeminiProvider, 'chat', side_effect=Exception("API Error")):
    ...
    def test_groq_provider_error_handling(self):
        ...
        with patch.object(GroqProvider, 'is_available', return_value=True):
            with patch.object(GroqProvider, 'chat', side_effect=Exception("API Error")):
    ...
    def test_ollama_provider_error_handling(self):
        ...
        with patch.object(OllamaProvider, 'is_available', return_value=True):
            with patch.object(OllamaProvider, 'chat', side_effect=Exception("API Error")):
    ...
    def test_embedding_error_handling(self):
        ...
        with patch.object(GeminiProvider, 'is_available', return_value=True):
            with patch.object(GeminiProvider, 'get_embedding', side_effect=Exception("API Error")):
