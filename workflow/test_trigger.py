...
import threading
from workflow.trigger import TimeBasedTrigger, EventBasedTrigger, ConditionBasedTrigger, TriggerManager
...
class TestWorkflowTriggers(unittest.TestCase):
    ...
    def test_time_based_trigger_with_interval(self):
        ...
        trigger = TimeBasedTrigger("time_trigger_2", self.callback, trigger_time, interval)
        trigger.start()
    ...
    def test_event_based_trigger(self):
        ...
        condition = lambda x: x == "test_data"
        trigger = EventBasedTrigger("event_trigger_1", self.callback, "test_event", condition)
        trigger.start()
    ...
    def test_condition_based_trigger(self):
        ...
        trigger = ConditionBasedTrigger("condition_trigger_1", self.callback, condition, check_interval=1.0)
        trigger.start()
    ...
    def test_trigger_manager(self):
        ...
        event_trigger = EventBasedTrigger("event_trigger_2", self.callback, "test_event_2")
