...
from workflow.error_handling import AlwaysContinue, StopOnCritical
...
class TestAdvancedWorkflowEngine(unittest.TestCase):
    ...
    def test_execute_parallel_success(self):
        ...
        self.assertLess(end_time - start_time, 1.5)  # Should be parallel, so less than sequential time
    ...
    def test_execute_conditional_true(self):
        ...
        true_action = lambda: "True Result"
        false_action = lambda: "False Result"
    ...
    def test_register_and_execute_template(self):
        ...
        template = {
            ...
            "actions": [
                ...
                {"type": "parallel", "actions": [{"name": "parallel1"}, {"name": "parallel2"}]},
                {"type": "conditional", "condition": {"name": "cond1"}, "true_action": {"name": "true_act"}, "false_action": {"name": "false_act"}}
            ]
        }
