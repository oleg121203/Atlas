...
class NLWorkflowGenerator:
    ...
    def _load_workflow_patterns(self) -> Dict[str, Any]:
        ...
        pattern_file = os.path.join(
            os.path.dirname(__file__), "..", "workflow_patterns.json"
        )
        try:
    ...
    def _load_user_history(self) -> List[Dict[str, Any]]:
        ...
        history_file = os.path.join(
            os.path.dirname(__file__), "..", "data", "user_workflow_history.json"
        )
        try:
    ...
    def generate_workflow(
        ...
        try:
            ...
            contextual_prompt = self.prompt_generator.generate_contextual_prompt(
                base_prompt, user_id, context_data
            )
            ...
            self.feedback.add_feedback(
                workflow, nl_input, 3, "Auto-generated initial feedback"
            )
            return workflow
        except Exception as e:
